...
CREATE TABLE `client_order` (
  ...
  KEY `IDX_56440F2F89366B7B` (`tutorial_id`),
  CONSTRAINT `FK_56440F2F89366B7B` FOREIGN KEY (`tutorial_id`) REFERENCES `tutorial` (`id`),
...
INSERT INTO `client_order` VALUES (16,NULL,3,1),(17,NULL,3,4);
...
CREATE TABLE `fos_user` (
  ...
  `user_coins` int(11) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `fos_user` VALUES (1,'user1','user1','user1@user.pl','user1@user.pl',1,NULL,'$2y$13$lXY6JX5qrT2JQdoL/6FOGeh93e8.O90OuS4Xp6MI2e8E6natdTMoK','2017-08-02 20:32:57',NULL,NULL,'a:0:{}','user1','user1',500),(2,'user2','user2','user2@user.pl','user2@user.pl',1,NULL,'$2y$13$ZGAwbTQAx69GPfWJGgmal.ABBlsEuU6oGTXln6l64inTedgiz0dnS','2017-08-02 20:34:37',NULL,NULL,'a:0:{}','user2','user2',560),(3,'user3','user3','user3@user.pl','user3@user.pl',1,NULL,'$2y$13$yoeas7kNT3XAndtd0KCsnOOV.7yX8N0NjPbFusj4c9FX1PZoVPmcG','2017-08-03 14:41:42',NULL,NULL,'a:0:{}','user3','user3',300);
...
-- Dump completed on 2017-08-03 16:39:57
